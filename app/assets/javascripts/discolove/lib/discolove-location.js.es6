...
/**
  `Ember.DiscoloveLocation` implements the location API using the browser's
  `history.pushState` API.

  @class DiscoloveLocation
  @namespace Discolove
  @extends Ember.Object
*/
const DiscoloveLocation = Ember.Object.extend({
  ...
  */
  getURL() {
    ...
    url = url.replace(Discolove.BaseUri, '');
...
export default DiscoloveLocation;
